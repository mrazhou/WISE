...
def extract_bbox_points_think(output_text, x_factor, y_factor):
    ...
    if json_match:
        ...
        # 查找points键
        points_keys = [key for key in data.keys() if 'point' in key.lower()][:2]  # 获取前两个points键
        points = None
...
def main():
    ...
    dataset = dataset.shuffle(seed=20)
    ...
    with open(os.path.join(json_output_path, f"time_{args.idx}.txt"), "w") as f:
